module ReactBootstrap.Types where
...
foreign import data EventKey :: Type

-- export type EventKey = string | number;

eventKey :: String -> EventKey
eventKey = unsafeCoerce

instance Eq EventKey where
  eq e1 e2 = (unsafeCoerce e1 :: String) == (unsafeCoerce e2 :: String)

type SelectCallback = EffectFn2 EventKey SyntheticEvent Unit
